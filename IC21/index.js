//default profile for yl212
let defaultProfile = {
    username: 'yl212',
    email: 'yl212@rice.edu',
    zipcode: '77005',
...
const getEmail  = (req, res) => {
    ...
    const email = username===defaultProfile.username? defaultProfile.email: 'yl212@rice.edu'
...
const getDob = (req, res) => {
    const username = req.params.user ? req.params.user: defaultProfile.username
    const dob = username===defaultProfile.username ? defaultProfile.dob: new Date("1995-10-10")
